...
int main() {
    ...
    const Pose stereo = getPose(Vec3(-1.0, 0.0, 0.0));
    ...
    // generate test pose
    {
        poses.push(getPose(Vec3(+00.0, 0.0, 400)));
        poses.push(getPose(Vec3(0.0, +10.0, 400)) * getRotAngleX(+30 * SP_PI / 180.0));
        poses.push(getPose(Vec3(0.0, -10.0, 400)) * getRotAngleX(-30 * SP_PI / 180.0));
        poses.push(getPose(Vec3(+10.0, 0.0, 400)) * getRotAngleY(+30 * SP_PI / 180.0));
        poses.push(getPose(Vec3(-10.0, 0.0, 400)) * getRotAngleY(-30 * SP_PI / 180.0));
    }
    ...
    // test (generate test points)
    {
        ...
        for (int i = 0; i < poses.size(); i++) {
            ...
            for (int n = 0; n < mrkMap.size(); n++) {
                const Vec3 pos = poses[i] * Vec3(mrkMap[n].x, mrkMap[n].y, 0.0);
